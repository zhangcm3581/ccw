...
**实施后的实际状态（2026-07-26）：**V1–V7、V11由单测覆盖并通过（`cmd/worker-agent` 12条、`internal/config` 4条、`internal/store`需真实PG故本机skip、CI有Postgres集成job）。**V8–V10未跑**，需要真实部署。自查步骤见`DEPLOY.md`第11.2节。
